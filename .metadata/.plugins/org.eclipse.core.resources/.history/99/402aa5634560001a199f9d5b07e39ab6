...
public class App {
	...
	private static final String DOC = 
		  "\n-------------------------------------------------"
	    + "\n  "+APPNAME+" ("+VERSION+")"
	    + "\n  Jacek Apanasik, ZPSB AiSMn, sem.5, 2019.12.12"
	    + "\n-------------------------------------------------"
	    + "\n"
	    ...
	    + "\n               Wartoœæ pomijana gdy jest ustawiony parametr -d."
	    + "\n    -d --date=<d>"
	    + "\n               Data prognozy spoœród kolejnych 15 dni (w formacie YYYY-MM-DD)."
	    + "\n    -i --interval=<i>"
	    + "\n               Przedzia³y czasowe prognozy (1,3,6,12,24 godzin) [default: 3]"
	    + "\n    -h --help  Wyœwietla ten ekran."
	    + "\n    --version  Wyœwietla nr wersji programu."
	    + "\n"
	    
		+ "\n    LOCATION:  Nazwa miejscowoœci i/lub kraju (np. swinoujscie lub swinoujscie,poland)"
		+ "\n         lub   Adres IP (XXX.XXX.XXX.XXX)"
		+ "\n         lub   Szerokoœæ i d³ugoœæ geograficzna (XX.XXX,XX.XXX)"
		+ "\n";
...
//	private static final String APIKEY = "27fe0a8d46cb4527acc213835201401"; 
	...
	public static void main(String[] args) {
	    ...
	    if(js.has("data.error.0.msg")) {
	    	String err = "\nNie mo¿na znaleŸæ lokalizacji '"+ap.getLocation()+"'\n";
